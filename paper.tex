...
using the Boolean AND, and everything else, colored yellow, is rendered.
}
\label{boolean-and}
\end{figure}
...
instead of the front faces of the cube.  Note in the code snippet below we omit
the instructions for rendering the second volume and for setting uniform
variables.  We also put the Boolean AND into a group so it can be redrawn later
without duplicating the calculations or geometry.
