...
perspective one of the pieces may actually appear behind the other.  In the
future, this issue may be solved by using the distance from the camera to sort
rather than the actual depth.
