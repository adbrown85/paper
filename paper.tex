...
volumes intersect, it is shown that Boolean operations can be used so that the
camera may move without regenerating any geometry.  Although viable options it
is shown that two new methods are no faster than the traditional slicing method.
\end{abstract}
