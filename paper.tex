...
From there an application was created to view RapidGL scenes.  It can rotate the
camera around the scene, as well as select objects in the scene and drag them
around.  It shows the current frame rate so we can evaluate the performance of
the scenes.
