...
acceleration have been developed, but they can require a large amount of
geometry to be created every frame, or may be difficult or time-consuming to
implement.  This paper investigates whether using familiar Boolean operations
may be faster or easier to implement in the simple case where two axis-aligned
volumes intersect.
\end{abstract}
