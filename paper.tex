...
the camera may move without regenerating any geometry.  However, the two
variations presented herein still achieve similar frame rates to that of the
canonical slicing method.
\end{abstract}
...
Core i7 system with a Quadro FX 5800 video card.  Here the difference between
the methods is more dramatic.  Both slicing methods handedly beat the
