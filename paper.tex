...
implement.  This paper investigates whether using Boolean operations may be
faster or easier to implement in the simple case where two axis-aligned volumes
intersect.
\end{abstract}
