...
rotate the camera around a scene, as well as select objects and drag them.  It
shows the current frame rate so we can evaluate the performance of the scenes.
